loader.define(function(require, exports, module) {
    ...
    pageview.init = function () {
        ...
        var alarm = _.find(alarms, function(item){ return item.SerialNO == params.id; });
        if(isNull(alarm) === true)
            return;

        var devices = getDevices();
        var device = _.find(devices, function(item){ return item.ID === alarm.DeviceID; });
        _fill(alarm, device);
    }

loader.define(
  ["pages/main/alarmreport"],
  function (report, require, exports, module) {
    var pageview = {
      name: "历史告警列表",
      request: null,
      pull: null,
        ...
        this.pull = this.request.GetList(
          {
            ...
            template: function (data) {
              ...
              $.each(data, function (index, el) {
                html += `<li class="bui-btn bui-box" href="pages/main/alarmdetail.html?Area=${
                  el.Area
                }&Station=${el.Room}&Device=${el.Device}&Signal=${
                  el.Signal
                }&SignalID=${el.SignalID}&AlarmLevel=${
                  el.AlarmLevel
                }&AlarmDesc=${el.AlarmDesc}&StartTime=${el.StartTime}&EndTime=${
                  el.EndTime
                }&ConfirmTime=${el.ConfirmTime || ""}&Confirmer=${
                  el.Confirmer || ""

...
loader.define(function (require, exports, module) {
  ...
  pageview.load = function () {
    this.nodes = [];
    this.loading.show();
    getAllSignalsByPid(this.params.id, null, function (data) {
      var xnodes = [];
  ...
  function _drawui(data) {
    ...
    $.each(data, function (index, item) {
      html += "\n            <li class=\"bui-btn\" href=\"pages/main/player.html?id=".concat(item.ID, "\">\n                <div class=\"bui-icon primary round\"><i class=\"appiconfont appicon-camera\"></i></div>\n                <div class=\"span1 camera-title\">").concat(item.Name, "</div>\n            </li>");
    });
    html += "</ul>";

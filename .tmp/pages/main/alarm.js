...
loader.define(function (require, exports, module) {
    ...
    if (isNull(this.pull) === true) {
      this.pull = bui.pullrefresh({
        ...
        onRefresh: function onRefresh() {
          pageview.refresh(null, function (err) {
            warning(err);
          }, function () {
  ...
  function _settimer(timeout) {
    pageview.timer = setTimeout(function () {
      pageview.refresh(_getparams(), function (err) {}, function () {
        _cleartimer();
  ...
  function _initsidebar() {
    ...
    var select = pageview.select; //初始化

...
loader.define(function () {
  ...
  pageview.init = function () {
    ...
    if (isNull(this.pull) === true) {
      ...
      this.view = bui.listview({
        ...
        callback: function callback(e, menu) {
    ...
    if (isNull(this.aodialog) === true) {
      this.aodialog = bui.dialog({
        ...
        height: "60%",
        buttons: [],
        callback: function callback(e, me) {
          var button = $(e.target);
  ...
  pageview.load = function () {
    ...
    $.when(getDeviceTask(id), getAllSignalsByPidTask(id)).done(function (v1, v2) {
      if (isNull(v1) === false) {
        pageview.device = v1;
  ...
  function _initdi(nodes) {
    ...
    $.each(nodes, function (index, item) {
      html += "<li id=\"pylon-data-signal-".concat(item.ID, "\" status=\"1\" data-id=\"").concat(item.ID, "\" data-type=\"").concat(item.Type, "\" data-desc=\"").concat(item.ValueDesc, "\">\n                <div class=\"bui-btn bui-box item-box\">\n                    <div class=\"signal-icon ").concat(getStateCls1(item.State), "\"><i class=\"appiconfont appicon-signal\"></i></div>\n                    <div class=\"span1\">\n                        <div class=\"bui-box item-title-box\">\n                            <div class=\"span1 item-title\">").concat(item.Name, "</div>\n                            <div class=\"item-text item-sub-title ").concat(getStateCls1(item.State), "\">").concat(getStateName(item.State), "</div>\n                        </div>\n                        <div class=\"bui-box item-text-box\">\n                            <div class=\"span1 item-text\">\n                                <span class=\"item-value\">").concat(getNodeValue(item.Type, item.Value, item.ValueDesc), "</span> \n                            </div>\n                            <div class=\"item-text\">\n                                <span class=\"item-time\">").concat(item.Time, "</span>\n                            </div>\n                        </div>\n                    </div>\n                </div>");

      if (isNull(item.AlarmSets) == false && item.AlarmSets.length > 0) {
        html += "<div class=\"bui-listview-menu swipeleft\"><div class=\"bui-btn danger\" data-id=\"".concat(item.ID, "\" data-type=\"").concat(item.Type, "\">\u544A\u8B66\u8BBE\u5B9A</div></div>");
      }
  ...
  function _initai(nodes) {
    ...
    var html = "";
    $.each(nodes, function (index, item) {
      html += "<li id=\"pylon-data-signal-".concat(item.ID, "\" status=\"1\" data-id=\"").concat(item.ID, "\" data-type=\"").concat(item.Type, "\" data-desc=\"").concat(item.ValueDesc, "\">\n                <div class=\"bui-btn bui-box item-box\">\n                    <div class=\"signal-icon ").concat(getStateCls1(item.State), "\"><i class=\"appiconfont appicon-signal3\"></i></div>\n                    <div class=\"span1\">\n                        <div class=\"bui-box item-title-box\">\n                            <div class=\"span1 item-title\">").concat(item.Name, "</div>\n                            <div class=\"item-text item-sub-title ").concat(getStateCls1(item.State), "\">").concat(getStateName(item.State), "</div>\n                        </div>\n                        <div class=\"bui-box item-text-box\">\n                            <div class=\"span1 item-text\">\n                                <span class=\"item-value\">").concat(getNodeValue(item.Type, item.Value, item.ValueDesc), "</span> \n                            </div>\n                            <div class=\"item-text\">\n                                <span class=\"item-time\">").concat(item.Time, "</span>\n                            </div>\n                        </div>\n                    </div>\n                </div>");
  ...
  function _initao(nodes) {
    ...
    var html = "";
    $.each(nodes, function (index, item) {
      html += "<li id=\"pylon-data-signal-".concat(item.ID, "\" status=\"1\" data-id=\"").concat(item.ID, "\" data-type=\"").concat(item.Type, "\" data-desc=\"").concat(item.ValueDesc, "\">\n                <div class=\"bui-btn bui-box item-box\">\n                    <div class=\"signal-icon ").concat(getStateCls1(item.State), "\"><i class=\"appiconfont appicon-wifi\"></i></div>\n                    <div class=\"span1\">\n                        <div class=\"bui-box item-title-box\">\n                            <div class=\"span1 item-title\">").concat(item.Name, "</div>\n                            <div class=\"item-text item-sub-title ").concat(getStateCls1(item.State), "\">").concat(getStateName(item.State), "</div>\n                        </div>\n                        <div class=\"bui-box item-text-box\">\n                            <div class=\"span1 item-text\">\n                                <span class=\"item-value\">").concat(getNodeValue(item.Type, item.Value, item.ValueDesc), "</span> \n                            </div>\n                            <div class=\"item-text\">\n                                <span class=\"item-time\">").concat(item.Time, "</span>\n                            </div>\n                        </div>\n                    </div>\n                </div>\n                <div class=\"bui-listview-menu swipeleft\"><div class=\"bui-btn primary\"  data-id=\"").concat(item.ID, "\" data-type=\"").concat(item.Type, "\">\u8FDC\u7A0B\u8BBE\u5B9A</div></div></li>\n                </li>");
    });
    container.html(html);
    footer.html('<div class="nomore">没有更多内容</div>');
  }
  ...
  function _initdo(nodes) {
    ...
    var html = "";
    $.each(nodes, function (index, item) {
      html += "<li id=\"pylon-data-signal-".concat(item.ID, "\" status=\"1\" data-id=\"").concat(item.ID, "\" data-type=\"").concat(item.Type, "\" data-desc=\"").concat(item.ValueDesc, "\">\n                <div class=\"bui-btn bui-box item-box\">\n                    <div class=\"signal-icon ").concat(getStateCls1(item.State), "\"><i class=\"appiconfont appicon-wifi\"></i></div>\n                    <div class=\"span1\">\n                        <div class=\"bui-box item-title-box\">\n                            <div class=\"span1 item-title\">").concat(item.Name, "</div>\n                            <div class=\"item-text item-sub-title ").concat(getStateCls1(item.State), "\">").concat(getStateName(item.State), "</div>\n                        </div>\n                        <div class=\"bui-box item-text-box\">\n                            <div class=\"span1 item-text\">\n                                <span class=\"item-value\">").concat(getNodeValue(item.Type, item.Value, item.ValueDesc), "</span> \n                            </div>\n                            <div class=\"item-text\">\n                                <span class=\"item-time\">").concat(item.Time, "</span>\n                            </div>\n                        </div>\n                    </div>\n                </div>\n                <div class=\"bui-listview-menu swipeleft\"><div class=\"bui-btn primary\" data-id=\"").concat(item.ID, "\" data-type=\"").concat(item.Type, "\">\u8FDC\u7A0B\u63A7\u5236</div></div></li>\n                </li>");
    });
    container.html(html);
    footer.html('<div class="nomore">没有更多内容</div>');
  }
  ...
  function _initci(nodes) {
    ...
    var html = "";
    $.each(nodes, function (index, item) {
      html += "<li id=\"pylon-data-signal-".concat(item.ID, "\" status=\"1\" data-id=\"").concat(item.ID, "\" data-type=\"").concat(item.Type, "\" data-desc=\"").concat(item.ValueDesc, "\">\n                <div class=\"bui-btn bui-box item-box\">\n                    <div class=\"signal-icon ").concat(getStateCls1(item.State), "\"><i class=\"appiconfont appicon-signal2\"></i></div>\n                    <div class=\"span1\">\n                        <div class=\"bui-box item-title-box\">\n                            <div class=\"span1 item-title\">").concat(item.Name, "</div>\n                            <div class=\"item-text item-sub-title ").concat(getStateCls1(item.State), "\">").concat(getStateName(item.State), "</div>\n                        </div>\n                        <div class=\"bui-box item-text-box\">\n                            <div class=\"span1 item-text\">\n                                <span class=\"item-value\">").concat(getNodeValue(item.Type, item.Value, item.ValueDesc), "</span> \n                            </div>\n                            <div class=\"item-text\">\n                                <span class=\"item-time\">").concat(item.Time, "</span>\n                            </div>\n                        </div>\n                    </div>\n                </div>\n                <div class=\"bui-listview-menu swipeleft\"><div class=\"bui-btn danger\" data-id=\"").concat(item.ID, "\" data-type=\"").concat(item.Type, "\">\u590D\u4F4D</div></div>\n                </li>");
    });
    container.html(html);
    footer.html('<div class="nomore">没有更多内容</div>');
  }
  ...
  function _opendo(node) {
    ...
    $.each(getUnits(node.ValueDesc), function (index, item) {
      data.push({
        name: String.format("{0}-{1}", item.name, item.id),
        value: item.id
      });
    });
